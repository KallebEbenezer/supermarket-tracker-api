...
public class SecurityConfiguration {
        ...
        return http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(
                                ...
                                "/api/v1/integracoes/sumup/oauth/callback",
                                "/api/v1/webhooks/**",
                                "/ws/**",
                                "/",
                                "/index.html",
                                ...
                                "/actuator/**")
                        .permitAll()
                        // O token Tap-to-Pay permite iniciar uma cobrança no
                        // dispositivo. Somente perfis operacionais do PDV podem
                        // solicitá-lo; nunca o exponha a usuários de consulta.
                        .requestMatchers("/api/v1/integracoes/sumup/**")
                        .hasAnyRole("PROPRIETARIO", "ADMIN", "GERENTE", "CAIXA")
    ...
    /**
     * A API aceita exclusivamente JWT Bearer. Este bean evita que o Spring
     * configure uma conta em memória com senha aleatória como alternativa de login.
     */
    @Bean
    UserDetailsService jwtOnlyUserDetailsService() {
        return username -> {
            throw new UsernameNotFoundException("Autenticação por senha não é suportada.");
        };
    }
}
